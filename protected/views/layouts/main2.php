...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    ...
    .errorMessage{
        ...
        <?php if (Yii::app()->user->getLevel()==6 || Yii::app()->user->getLevel()==99 ): ?>
        ...
        <div id="header">
            ...
            'items'=>array(
                ...
                // array('label'=>'Grafik','url'=>array('/sales/grafik'), 'visible' => !Yii::app()->user->isGuest,),
                  ...
                  'items'=>array(
					...
					array('label'=>'Atur Pajak', 'visible' => Yii::app()->user->name == 'manager', 'url'=>array('/site/pajak')),
                ...
                array('label'=>'Grafik', 'visible' => $userlevel==3 || $userlevel==2 || $userlevel==1 ,
                  'items'=>array(
                    ...
                    array('label'=>'Penjualan Terbanyak','url'=>array('/sales/bsgrafik')), 
                ...
                // array('label'=>'Piutang','url'=>array('/sales/datahutang','mode'=>'top'), 'visible' => $a), 
                 ...
                 array('label' => 'Laporan  ', 'url' => array('/site/laporanpenjualan'),  'visible' =>$userlevel==99 || $userlevel==2),
         ...
         // array('label' => 'Pajak ', 'url' => array('/site/pajak'),  'visible' =>$userlevel==3 || $userlevel==2),
                 // array('label' => 'Atur Pajak ', 'url' => array('/site/pajak'),  'visible' =>$userlevel==3 || $userlevel==2),
                array('label' => 'Laporan Pajak',  'visible' =>Yii::app()->user->name == 'manager','url'=>array('/sales/lappajak')),
                //    'items'=>array(
                //    array('label'=>'Parameter Pajak','url'=>array('/site/pajak')), 
                //    array('label'=>'Laporan Pajak','url'=>array('/sales/lappajak')),
                //  )),
