...
//            print_r($model);
	...
	public function actionAdmin()
	{
		...
		// $idh = $_REQUEST['id'];
		$rawData = Yii::app()->db->createCommand()
		->select('i.id, item_name, item_number, description, c.category as category, unit_price, o.nama_outlet as nm, o.kode_outlet')
		->from('items  i , outlet o, categories as c')
		->where("o.kode_outlet = i.kode_outlet and c.id = i.category_id and i.category_id != 5")
		->group("i.id")
		->queryAll();
