 ...
 */
class SalesItems extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('sale_id, item_id, quantity_purchased, item_tax, item_price, item_discount', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search()., item_total_cost
	...
	public function relations()
	{
		...
		return array(
			...
			'sales'=>array(self::BELONGS_TO,'Sales','sale_id')
		);
	}
