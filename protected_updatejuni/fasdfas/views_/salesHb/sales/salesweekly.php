...
<?php $form=$this->beginWidget('CActiveForm',array(
	'action'=>Yii::app()->createUrl('sales/salesweekly'),
	'method'=>'get',
)); ?>
<div class="row">
		<?php
...
<?php $this->widget('zii.widgets.grid.CGridView', array(
	...
	// array(
			// 'name'=>'Branch',
			// 'type'=>'raw',
			// 'value'=>'getBranch($data->branch)'
		// ),
		// array(
			// 'name'=>'Customer',
			// 'type'=>'raw',
			// 'value'=>'getCustomer($data->customer_id)'
		// ),
		// 'paidwith_id',
		array(
			'name'=>'Bayar',
			'type'=>'raw',
			'value'=>'getPaid($data->paidwith_id)'
		),
		array(
		'name'=>'total_items',
		'header'=>'QTY',
...
//			'value'=>'$data->nilai',
		...
		array( 'class'=>'CButtonColumn','template'=>'{delete}','visible'=>$a,), 		
	),
)); ?>
<?php
