		...
		<div id="header">
			...
			//	array('label'=>'Laporan Periode','url'=>array('/sales/salesmonthly'), 'visible' => !Yii::app()->user->isGuest,
             //   ), 
                ...
                array('label'=>'Laporan Mingguan', 'visible' => !Yii::app()->user->isGuest,
                  'items'=>array( 
                ...
                // array('label'=>'Grafik','url'=>array('/sales/grafik'), 'visible' => !Yii::app()->user->isGuest,),
                  ...
                  'items'=>array( 
                    ...
                    array('label'=>'Tenant','url'=>array('/Outlet/admin','view'=>'sub1')), 
                    array('label'=>'User','url'=>array('/Users/admin','view'=>'sub1')), 
                    ), 
                  ), 
				  
				  
				  array('label'=>'Setting',  'visible' => $a,
				  'items'=>array(
				...
				array('label'=>'Grafik', 'visible' => $a,
				  'items'=>array(
                    array('label'=>'Penghasilan bersih','url'=>array('/sales/grafik','mode'=>'bersih')), 
                    array('label'=>'Top 10 makanan terlaris','url'=>array('/sales/grafik','mode'=>'top')), 
