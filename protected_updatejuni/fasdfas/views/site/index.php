...
function hutang(){
    ...
    <div class="content-pos-grid">
        <div class="inputtab">
            <form id="sales-hb" action="<?php echo $this->createUrl('SalesHb/save') ?>">
                ...
                <label>Diskon
                    <?php echo CHtml::dropDownList('discount', '0', array('0'=>'0','5'=>'5','10'=>'10','20'=>'20'),array('class' => 'myinput', 'onkeypress' => 'return runScript(event,"add_item")')); ?> % </label>
    ...
    <div class="content-pos-kanan">
		...
		<div style="text-align:right;"><input type=button onClick="travel()" value="Travel" class="mybutton"></div>
    </div>
</div>
<script>
	function travel(){
...
<script>
    $(document).ready(function() { 
		...
		function changebayar(){
			var bayar = $("#cash").val();
			$("#cash").val(bayar.replace(/[^\d,]+/g, ''));
			bayar = parseInt($("#cash").val())+parseInt($("#edcbca").val())+parseInt($("#edcniaga").val())+parseInt($("#voucher").val())+parseInt($("#compliment").val())+parseInt($("#dll").val());
			// bayar = bayar.replace(/[^\d,]+/g, '');
			var sum_sale_total = $("#sum_sale_total").html();
			var kembalian = bayar-sum_sale_total;
			$("#kembalian").val(kembalian);
			$("#cash").val(parseInt($("#sum_sale_total").html())-parseInt($("#edcbca").val())-parseInt($("#edcniaga").val())-parseInt($("#voucher").val())-parseInt($("#compliment").val())-parseInt($("#dll").val()));
			// $("#voucher").val("haha");
