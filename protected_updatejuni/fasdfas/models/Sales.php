...
class Sales extends CActiveRecord {
    ...
    public function payment() {
        return array(1 => 'Cash', 3 => 'EDC BCA', 4 => 'EDC Mandiri', 5 => 'EDC Niaga', 12 => 'Compliment',99=>'voucher');
    }
    ...
    public function rules() {
        ...
        return array(
            ...
            array('customer_id, sale_sub_total, sale_discount, sale_service, sale_tax, sale_total_cost, sale_payment, paidwith_id, total_items, branch, user_id, table, status', 'numerical', 'integerOnly' => true),
