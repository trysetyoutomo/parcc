...
//        fwrite($fh, $pembatas . "\r \n");
	...
	$this->slg =  Branch::model()->findByPk(1)->slogan;
		...
		// ->select('
		// SUM( s.sale_tax ) as tax, 
		// sum( s.sale_sub_total ) as cost, 
		// sum(s.sale_discount ) as tot_disc, 
		// sum(s.sale_total_cost) as stc  ,
		// s.id,
