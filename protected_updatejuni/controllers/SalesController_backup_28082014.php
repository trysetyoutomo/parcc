...
//        fwrite($fh, $pembatas . "\r \n");
	...
	$this->slg =  Branch::model()->findByPk(1)->slogan;
		...
		foreach($data1 as $dt1){
			...
			$tmp['total'] =     "Total Payment :";
			$tmp['totalvalue'] = "\r".number_format($dt1['total'])."\r\n";
			
			$tmp['comp'] =     "Compliment    :";
			$tmp['compvalue'] = "\r".number_format($dt1['compliment'])."\r\n";
			
			$tmp['netcash'] =  "Net Cash      :";
			$tmp['netcashvalue'] = "\r".number_format($dt1['cash'])."\r\n";

			$tmp['bca'] =      "BCA           :";
			$tmp['bcavalue'] = "\r".number_format($dt1['edc_bca'])."\r\n";

			$tmp['mandiri'] =  "Niaga         :";
			$tmp['mandirivalue'] = "\r".number_format($dt1['edc_niaga'])."\r\n";
			
			$tmp['niaga'] =    "Voucher       :";
			$tmp['niagavalue'] = "\r".number_format($dt1['voucher'])."\r\n";
			
			$tmp['dll'] =    "Dll           :";
			$tmp['dllvalue'] = "\r".number_format($dt1['dll'])."\r\n";
