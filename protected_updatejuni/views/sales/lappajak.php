...
<div id="cetak">
	...
	// echo $format1;
	?>
	<h2><center>Laporan Pajak Bulan <?php echo $format1; ?> Tahun <?php echo $tahun; ?></center></h2>
	...
	<tbody>
		<?php foreach ($nsqlpa2 as $nsqlpa2): ?>
		<tr>
			...
			<td style="text-align:right"><?php echo number_format($nsqlpa1['sale_sub_total']); ?></td>
			<?php 
			$subsps = $nsqlpa1['sale_sub_total'] - ($nsqlpa1['sale_discount'] + $nsqlpa3['voucher']);
			$pajak = $subsps * (10/100);
