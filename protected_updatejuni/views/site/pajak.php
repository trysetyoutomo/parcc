...
<table class="table">
	...
	foreach ($model as $m): ?>
		<tr>
			...
			<td class="sale_id" style="text-align:left"><?php echo $m[id]; ?></td>
			<td class="sale_idd" style="text-align:left"><?php echo $m[fid]; ?></td>
			<td style="text-align:left"><?php echo $m[date]; ?></td>
			<td><?php echo number_format($m[sale_sub_total]); ?></td>
			<td><?php echo number_format($m[discount]); ?></td>
			<td><?php echo number_format($m[voucher]); ?></td>
			<td><?php echo number_format($m[sale_dis_vouc]); ?></td>
			<?php 
...
?>
	<table style="width:150px;background:white;">
		...
		<tr>
			<td>Jumlah Pajak</td>
			<td><h1><?php echo number_format($Subtotal2 *0.1);?></h1></td>
		...
		<tr>
			...
			<td ><h1 style="color:red"><?php echo number_format($subtotal);?></h1></td>
		</tr>
		<tr>
			<td>Jumlah Bill</td>
		...
		<tr>
			<td>Jumlah Pajak</td>
			<td><h1 style="color:red"><?php echo number_format($subtotal *0.1);?></h1></td>
		</tr>
		<tr>
			<td>================================================</td>
		</tr>
		...
		<tr>
			...
			if (isset($_REQUEST[minimal])){
				try{	
					...
					echo round(($subtotal/$Subtotal2) * 100 )." %" ;
					}	
				}
				catch (Exception $e) {
			...
			<div id="val_jp" style="display:none"><?php echo round(($subtotal/$Subtotal2) * 100 ); ?></div>
			<?php } ?>
			</h1></td>
		</tr>
		<tr>
