...
<div id="mid-content">
    <div class="container" id="page">
        ...
        <div id="pos-content">
            <div class="title-content"><h3>Kasir</h3></div>    
            <?php echo $content; ?>
        </div>
        <div class="clear"></div>
    </div><!-- page -->
...
<div id="footer">
	<nav>
		<ul><li>F1 = Bayar </li><li> F2 = Pilih Menu </li><li> F3 = Meja</li><li> F7 = Cetak</li><li> F8 = Bayar Piutang</li><li> F9 = Update bill on table</li>
		</ul>
	</nav>
